...
impl ::core::cmp::PartialEq for RecoveryMessage {
    ...
    fn eq(&self, other: &RecoveryMessage) -> bool {
        self.nonce == other.nonce
            ...
            && self.address == other.address && self.value == other.value
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        "chain_id" => _serde::__private::Ok(__Field::__field4),
                        _ => _serde::__private::Ok(__Field::__ignore),
                    }
                }
                fn visit_bytes<__E>(
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        b"chain_id" => _serde::__private::Ok(__Field::__field4),
                        _ => _serde::__private::Ok(__Field::__ignore),
                    }
                }
            }
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                        ...
                        _serde::__private::None => {
                            return _serde::__private::Err(
                                _serde::de::Error::invalid_length(
                                    0usize,
                                    &"struct RecoveryMessage with 5 elements",
                                ),
                            );
                        }
                    };
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut __field4: _serde::__private::Option<Option<ChainId>> = _serde::__private::None;
...
const _: () = {
    ...
    impl alloy_rlp::Encodable for RecoveryMessage {
        ...
        fn encode(&self, out: &mut dyn alloy_rlp::BufMut) {
            ...
            alloy_rlp::Encodable::encode(&self.address, out);
            alloy_rlp::Encodable::encode(&self.value, out);
    ...
    impl RecoveryMessage {
        ...
        fn _alloy_rlp_payload_length(&self) -> usize {
            0usize + alloy_rlp::Encodable::length(&self.nonce)
                ...
                + alloy_rlp::Encodable::length(&self.address)
                + alloy_rlp::Encodable::length(&self.value)
                + self
                    .chain_id
                    .as_ref()
    ...
    impl alloy_rlp::Decodable for RecoveryMessage {
        ...
        fn decode(b: &mut &[u8]) -> alloy_rlp::Result<Self> {
            ...
            let this = Self {
                ...
                address: alloy_rlp::Decodable::decode(b)?,
